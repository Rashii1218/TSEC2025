...
const StudentProfile = () => {
  ...
  const profileData = {
    ...
    graduationYear: 2025,
    avatar: 'https://api.dicebear.com/6.x/adventurer/svg?seed=Alex',
    badges: [
      { 
        name: 'Hackathon Winner', 
        icon: '🏆',
        color: 'from-[white] to-[#480ca8]',
    ...
    details: [
      { 
        icon: <CapIcon className="text-[#560bad] mr-3" />,
        label: 'Major', 
    ...
    progressDetails: [
      { 
        icon: <FaBriefcase className="text-[#560bad] mr-3" />,
        label: 'Internships', 
        value: 2,
        color: 'bg-[#b8c0ff]'
      },
      { 
        icon: <FaCode className="text-[#560bad] mr-3" />,
        label: 'Projects', 
        value: 5,
        color: 'bg-[#c8b6ff]'
      }
