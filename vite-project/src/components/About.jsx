...
// const About = () => {
//   return (
//     <div id="about" className="max-w-7xl mx-auto px-4 py-16 bg-gradient-to-br from-gray-50 via-purple-100 to-gray-200 text-gray-900 rounded-lg shadow-lg mt-16">
...
//             <div>
//               <h3 className="text-xl font-semibold text-gray-800">Recognition</h3>
//               <p className="text-gray-600">
...
const About = () => {
  return (
    <div
      id="about"
      className="max-w-7xl mx-auto px-4 py-16 bg-gradient-to-br from-purple-950 via-black to-purple-950 text-white rounded-xl shadow-lg"
    >
